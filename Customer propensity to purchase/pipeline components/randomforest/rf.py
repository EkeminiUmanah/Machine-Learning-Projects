...
def rf(clean_data):
    ...
    rfcla = RandomForestClassifier(max_features='auto',n_estimators=20, max_depth=5, min_samples_leaf=100) 
    ...
    rf_metrics = {'train':train, 'test':test, 'report':df_classification_report, 'model':rfcla}
